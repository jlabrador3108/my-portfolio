...
const Hero = () => {
  ...
  const object = {
    ...
    content: {
      es: "Desarrollador de software web full stack con 4 años de experiencia en el diseño, desarrollo e implementación de aplicaciones web robustas. Competente en Node.js, Express.js, NestJS, Python, Django y React.js, con una pasión por resolver problemas y ofrecer soluciones escalables.",
      en:
        "Full stack web software developer with 4 years of experience in designing, developing, and implementing robust web applications. " +
        "Proficient in Node.js, Express.js, NestJS, Python, Django, React.js, with a passion for" +
    ...
    <section className="h-screen w-full max-w-full bg-gray-100 dark:bg-gray-800 flex flex-col justify-center items-center text-center">
      <div className="flex flex-col md:flex-row items-center justify-center content-center">
        <img
          ...
          alt="Perfil photo"
          className="w-2/4 h-2/4 md:w-56 mt-28 md:mt-0 md:h-56 rounded-full shadow-lg object-cover mb-6 md:mb-0 transition-transform duration-700 ease-in-out transform hover:scale-110 hover:rotate-3 hover:opacity-90 hover:w-80 hover:h-80"
        />
